...
Meteor.methods({
    ...
    addMessage: function(text, id_conv){
        ...
        */
        ...
        /*
            Update de la conversation:
            - Récupération de l'objet à cibler (utilisateur courant dans views) - $elemMatch
            - Modification de la vue de l'utilisateur à true - $set
        */
        updateView = Conversations.update(
            {
                _id : id_conv,
                'public.views' : {
                    $elemMatch : { 'user' : this.userId }
                }
            },{
                $set : {
        ...
        // Retroune l'id du document modifié
        return updateView;
    }
